    ...
    <div className="min-h-screen bg-[#e8eaf0] flex items-center justify-center px-6">
      <div className="bg-white rounded-2xl shadow-sm w-full max-w-md p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            <input
              ...
              className="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm text-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>
        ...
        <p className="text-center text-sm text-gray-500 mt-6">
          ...
          <Link href="/login" className="text-blue-700 font-medium hover:underline hover:text-[#EE3539] transition-colors">
            Log in
          </Link>
        </p>
      </div>
